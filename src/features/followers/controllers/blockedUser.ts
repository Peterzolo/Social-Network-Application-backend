...
import { blockedUserQueue } from '@service/queues/blockQueue';
...
export class BlockedUser {
  public async block(req: Request, res: Response): Promise<void> {
    ...
    BlockedUser.prototype.updateBlockedUser(followerId, req.currentUser!.userId, 'block');
  ...
  public async unblock(req: Request, res: Response): Promise<void> {
    const { followerId } = req.params;
    BlockedUser.prototype.updateBlockedUser(followerId, req.currentUser!.userId, 'unblock');
